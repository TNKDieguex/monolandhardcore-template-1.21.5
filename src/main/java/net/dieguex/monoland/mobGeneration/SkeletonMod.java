    ...
    public static void register() {
        ...
        ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
            if (!(world instanceof ServerWorld serverWorld))
                return;
            if (!(entity instanceof AbstractSkeletonEntity skeleton) || entity instanceof WitherSkeletonEntity)
                return;
            ...
            if (ModTimeManager.hasPassedDays(0)) {
                ...
                MobEntity upgraded = SkeletonFactory.spawnCustomSkeleton(serverWorld, skeleton.getBlockPos(), type);
                if (upgraded != null) {
