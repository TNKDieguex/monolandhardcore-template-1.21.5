...
public class SilverFish {
        ...
        ServerEntityEvents.ENTITY_LOAD.register((entity, world) -> {
            ...
            if (ModTimeManager.hasPassedDays(10)) {
                ...
                if (silverfish.getStatusEffects().isEmpty()) {
                    applyEffectsToSpider(silverfish, chosen);
                }
    ...
    private static void applyEffectsToSpider(SilverfishEntity silverfish, List<RegistryEntry<StatusEffect>> effects) {
        for (RegistryEntry<StatusEffect> effect : effects) {
            silverfish.addStatusEffect(
